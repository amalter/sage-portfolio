<header class="banner home-header jumbotron jumbotron-fluid text-center row" style="background-image: url({{ get_the_post_thumbnail_url() }});">
  <div class="home-header_container container my-auto">
    ...
    <nav class="home-header_container-nav nav-primary">
      @if (has_nav_menu('home_navigation'))
        {!! wp_nav_menu(['theme_location' => 'home_navigation', 'menu_class' => 'nav flex-column']) !!}
      @endif
    </nav>
  </div>
</header>
